...
void MainScene::initialize()
{
	...
	Mesh* m{ MeshUtils::generate_cube(1.0f) };
	...
	cam2->set_position(Vec3f(2.0f, 0.0f, -5.0f));
	cam2->set_euler_angles(Vec3f{ 0.0f, -20.0f, 0.0f });
...
{
	cube->set_euler_angles(Vec3f{0.0, time / 100.0f, 0.0f});
	//cube->set_euler_angles(Vec3f{ 0.0, 0.0f, time / 100.0f });
