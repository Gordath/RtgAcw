...
namespace Glacier
{
	...
	bool D3D11RenderTarget::bind()
	{
		...
		device_context->OMSetRenderTargets(1, _render_target_view.ReleaseAndGetAddressOf(), _depth_buffer_view.Get());
	...
	bool D3D11RenderTarget::unbind() const
	{
		...
		ComPtr<ID3D11DeviceContext> device_context{ ctx->get_device_context() };
		device_context->OMSetRenderTargets(1, nullptr, nullptr);
